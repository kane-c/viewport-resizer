...
It remains as a convenient source for the below pre-configured bookmarklet. It is configured with current devices and screen sizes as of September 2019. These presets include:

* iPhone < 5, iPod Touch (320x480)
* iPhone 5/5c/5s/SE (320x568)
* iPhone 6/6s/7/8 (375x667)
* iPhone 6/6s/7/8 Plus (414x736)
* iPhone X/Xs/XR/11 Pro (375x812)
* iPhone Xs Max/11/11 Pro Max (414x896)
